...
export declare function listSources(token: string, work_id: string): r.R<r.ListSources>;
...
export declare function listDestinations(token: string, work_id: string, src_id: string): r.R<r.ListDestinations>;
...
export declare function listTrackingPlanSourceConnections(token: string, work_id: string, track_id: string): r.R<r.ListTrackingPlanSourceConnections>;
